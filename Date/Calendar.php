...
//    echo "which day is this month ".$this->monthToUse->format('j')."<br/>";
//    echo "which day is this week ".$this->monthToUse->format('w')."<br/>";
//    echo "How many days in this month ".$this->monthToUse->format('t');
//    echo "<br/>-------------------------------<br/>";
    $this->prepare();
  }
...
public function html($opts = array() )
{
  ...
  $nextMonthLink = sprintf($opts['month_link'],$nextMonth->format('m'),$nextMonth->format('Y'),'&raquo;');
